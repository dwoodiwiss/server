...
/* harmony import */ var _vendor_Caret_js_dist_jquery_caret_min__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./vendor/Caret.js/dist/jquery.caret.min */ "./apps/comments/src/vendor/Caret.js/dist/jquery.caret.min.js");
/* harmony import */ var _vendor_Caret_js_dist_jquery_caret_min__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_vendor_Caret_js_dist_jquery_caret_min__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _vendor_At_js_dist_js_jquery_atwho_min__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./vendor/At.js/dist/js/jquery.atwho.min */ "./apps/comments/src/vendor/At.js/dist/js/jquery.atwho.min.js");
/* harmony import */ var _vendor_At_js_dist_js_jquery_atwho_min__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_vendor_At_js_dist_js_jquery_atwho_min__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _style_autocomplete_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./style/autocomplete.scss */ "./apps/comments/src/style/autocomplete.scss");
/* harmony import */ var _style_autocomplete_scss__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_style_autocomplete_scss__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _style_comments_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./style/comments.scss */ "./apps/comments/src/style/comments.scss");
/* harmony import */ var _style_comments_scss__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_style_comments_scss__WEBPACK_IMPORTED_MODULE_12__);
...
(function (OC, OCA) {
  ...
  /** @lends OCA.Comments.CommentsTabView.prototype */
  {
    ...
    _initAutoComplete: function _initAutoComplete($target) {
      ...
      $target.atwho({
        ...
        displayTpl: function displayTpl(item) {
          return '<li>' + '<span class="avatar-name-wrapper">' + '<span class="avatar" ' + 'data-username="' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.id) + '" ' // for avatars
          + 'data-user="' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.id) + '" ' // for contactsmenu
          + 'data-user-display-name="' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.label) + '">' + '</span>' + '<strong>' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.label) + '</strong>' + '</span></li>';
        },
        insertTpl: function insertTpl(item) {
          return '' + '<span class="avatar-name-wrapper">' + '<span class="avatar" ' + 'data-username="' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.id) + '" ' // for avatars
          + 'data-user="' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.id) + '" ' // for contactsmenu
          + 'data-user-display-name="' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.label) + '">' + '</span>' + '<strong>' + escape_html__WEBPACK_IMPORTED_MODULE_0___default()(item.label) + '</strong>' + '</span>';
        },
        searchKey: 'label'
      });
    ...
    _formatMessage: function _formatMessage(message, mentions, editMode) {
      message = escape_html__WEBPACK_IMPORTED_MODULE_0___default()(message).replace(/\n/g, '<br/>');
